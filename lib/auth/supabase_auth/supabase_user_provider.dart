...
class MyGoalsStage15SupabaseUser extends BaseAuthUser {
  MyGoalsStage15SupabaseUser(this.user);
  User? user;
  @override
...
Stream<BaseAuthUser> myGoalsStage15SupabaseUserStream() {
  ...
  return (!loggedIn
      ...
      .map<BaseAuthUser>(
    (authState) {
      currentUser = MyGoalsStage15SupabaseUser(authState?.session?.user);
      return currentUser!;
    },
  );
}
